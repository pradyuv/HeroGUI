...
//was going to use switch case, but was informed by Mr.Solomon switch cases would not work with strings :(
if(theButtonChoice.equals("Superman")){

namesForJButton[0].createGUI();
}

if(theButtonChoice.equals("Batman")){

namesForJButton[1].createGUI();
}

if(theButtonChoice.equals("Aquaman")){

namesForJButton[2].createGUI();
}

if(theButtonChoice.equals("The Flash")){

namesForJButton[3].createGUI();
}

if(theButtonChoice.equals("Spider-Man")){

namesForJButton[4].createGUI();
}

if(theButtonChoice.equals("Thor Odinson")){

namesForJButton[5].createGUI();
}

if(theButtonChoice.equals("Iron Man")){

namesForJButton[6].createGUI();
}

if(theButtonChoice.equals("Wonder Woman")){

namesForJButton[7].createGUI();
}

if(theButtonChoice.equals("Ant-Man")){

namesForJButton[8].createGUI();
}

if(theButtonChoice.equals("Doctor Strange")){

namesForJButton[9].createGUI();
}

if(theButtonChoice.equals("The Incredible Hulk")){

namesForJButton[10].createGUI();
}

if(theButtonChoice.equals("Wolverine")){

namesForJButton[11].createGUI();
}

if(theButtonChoice.equals("Martian Manhunter")){

namesForJButton[12].createGUI();
}

if(theButtonChoice.equals("Quicksilver")){

namesForJButton[13].createGUI();
}

if(theButtonChoice.equals("Dr Manhattan")){

namesForJButton[14].createGUI();
}

if(theButtonChoice.equals("Deadpool")){

namesForJButton[15].createGUI();
} //clunky code, could have made more efficient with a switch case or something of the sort
